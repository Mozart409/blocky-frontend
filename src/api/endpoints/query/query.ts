...
export const getQueryMutationOptions = <TError = AxiosError<string>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof query>>, TError,{data: ApiQueryRequest}, TContext>, axios?: AxiosRequestConfig}
): UseMutationOptions<Awaited<ReturnType<typeof query>>, TError,{data: ApiQueryRequest}, TContext> => {
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof query>>, {data: ApiQueryRequest}> = (props) => {
          const {data} = props ?? {};

          return  query(data,axiosOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type QueryMutationBody = ApiQueryRequest
    export type QueryMutationError = AxiosError<string>
...
export const useDnsQuery = <TError = AxiosError<string>,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getQueryMutationOptions(options), queryClient);
    }
